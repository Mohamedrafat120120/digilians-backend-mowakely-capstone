...
const { createCaseSchema, updateCaseSchema, updateStatusSchema } = require('./cases.validation');
 ...
 */
router.patch('/:id/status', authenticate, validate(updateStatusSchema), caseController.updateStatus);
