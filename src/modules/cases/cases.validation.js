...
const updateStatusSchema = Joi.object({
  status: Joi.string().valid('open', 'in_progress', 'pending_payment', 'completed', 'cancelled', 'disputed').required()
});

module.exports = { createCaseSchema, updateCaseSchema, caseQuerySchema, updateStatusSchema };